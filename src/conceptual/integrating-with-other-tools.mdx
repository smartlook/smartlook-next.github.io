...
<TextBlock>{`
Technical details are provided in the respective <Link to="/api_reference#dashboard-session-url">Session URL API Reference</Link>.
`}</TextBlock>
...
<TextBlock>{`
Technical details are provided in the respective <Link to="/api_reference#dashboard-visitor-url">Visitor URL API Reference</Link>.
`}</TextBlock>
